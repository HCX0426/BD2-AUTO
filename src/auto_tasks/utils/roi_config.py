...
import json
import os
from typing import Any, Any, Optional, Tuple, Dict
...
class ROIConfig:
    ...
    def get_roi(self, roi_name: str, task_name: Optional[str] = None, default: Optional[Tuple[int, int, int, int]] = None) -> Optional[Tuple[int, int, int, int]]:
        """
        获取ROI配置
